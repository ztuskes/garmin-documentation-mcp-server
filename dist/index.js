            ...
            try {
                switch (name) {
                    case 'search_garmin_docs':
                        return await this.garminDocs.searchDocs(args.query, args.category || 'all');
                    case 'get_module_details':
                        return await this.garminDocs.getModuleDetails(args.module_name);
                    case 'get_class_details':
                        return await this.garminDocs.getClassDetails(args.class_name, args.module_name);
                    case 'list_modules':
